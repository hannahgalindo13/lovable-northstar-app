...
public class AnalyticsController : ControllerBase
{
    ...
    [AllowAnonymous]
    public async Task<ActionResult<object>> GetPublicDashboardStats()
    {
        try
        {
            ...
            var totalDonations = await _db.Donations.AsNoTracking().SumAsync(x => x.Amount ?? 0m);
    ...
    [AllowAnonymous]
    public async Task<ActionResult<object>> GetPublicImpactData()
    {
        try
        {
